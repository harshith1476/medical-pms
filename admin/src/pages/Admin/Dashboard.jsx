  ...
  return dashData && (
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white/80 backdrop-blur-sm p-4 min-w-52 rounded border border-white shadow-sm cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all'>
