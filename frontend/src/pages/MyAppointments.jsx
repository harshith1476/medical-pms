                        ...
                        >
                            ...
                            <div className="appointment-card-content">
                                <div className="flex items-start justify-between gap-2">
                                    <div>
                                        <h3 className="font-semibold text-gray-900 text-lg">{item.docData.name}</h3>
                                        <p className="text-cyan-600 font-medium text-sm">{item.docData.speciality}</p>
                                    </div>
                                ...
                                <div className="space-y-1 text-sm text-gray-600">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {item.tokenNumber && (
                                            <span className="ml-2 px-2 py-0.5 bg-cyan-100 text-cyan-700 rounded-full text-xs font-semibold">
